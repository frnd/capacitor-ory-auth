...
open class ClientRelationshipAPI {
     ...
     */
    @discardableResult
    open class func checkOplSyntax(body: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CheckOplSyntaxResult?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func checkOplSyntaxWithRequestBuilder(body: String? = nil) -> RequestBuilder<CheckOplSyntaxResult> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CheckOplSyntaxResult>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func createRelationship(createRelationshipBody: CreateRelationshipBody? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Relationship?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getRelationshipsWithRequestBuilder(pageToken: String? = nil, pageSize: Int64? = nil, namespace: String? = nil, object: String? = nil, relation: String? = nil, subjectId: String? = nil, subjectSetNamespace: String? = nil, subjectSetObject: String? = nil, subjectSetRelation: String? = nil) -> RequestBuilder<Relationships> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Relationships>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listRelationshipNamespaces(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: RelationshipNamespaces?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func listRelationshipNamespacesWithRequestBuilder() -> RequestBuilder<RelationshipNamespaces> {
        ...
        let localVariableRequestBuilder: RequestBuilder<RelationshipNamespaces>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func patchRelationships(relationshipPatch: [RelationshipPatch]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
