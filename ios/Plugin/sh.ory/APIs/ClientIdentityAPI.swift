...
open class ClientIdentityAPI {
     ...
     */
    @discardableResult
    open class func listIdentities(perPage: Int64? = nil, page: Int64? = nil, pageSize: Int64? = nil, pageToken: String? = nil, consistency: Consistency_listIdentities? = nil, credentialsIdentifier: String? = nil, previewCredentialsIdentifierSimilar: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [Identity]?, _ error: Error?) -> Void)) -> RequestTask {
        return listIdentitiesWithRequestBuilder(perPage: perPage, page: page, pageSize: pageSize, pageToken: pageToken, consistency: consistency, credentialsIdentifier: credentialsIdentifier, previewCredentialsIdentifierSimilar: previewCredentialsIdentifierSimilar).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<[Identity]> 
     */
    open class func listIdentitiesWithRequestBuilder(perPage: Int64? = nil, page: Int64? = nil, pageSize: Int64? = nil, pageToken: String? = nil, consistency: Consistency_listIdentities? = nil, credentialsIdentifier: String? = nil, previewCredentialsIdentifierSimilar: String? = nil) -> RequestBuilder<[Identity]> {
        let localVariablePath = "/admin/identities"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
