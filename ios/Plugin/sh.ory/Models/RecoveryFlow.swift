...
public struct RecoveryFlow: Codable, JSONEncodable, Hashable {
    ...
    public init(active: String? = nil, expiresAt: Date, id: String, issuedAt: Date, requestUrl: String, returnTo: String? = nil, state: AnyCodable?, type: String, ui: UiContainer) {
        self.active = active
