...
public struct Subscription: Codable, JSONEncodable, Hashable {
    ...
    public init(createdAt: Date, currency: Currency, currentInterval: CurrentInterval, currentPlan: String, customerId: String, id: String, intervalChangesTo: String?, ongoingStripeCheckoutId: String? = nil, payedUntil: Date, planChangesAt: Date? = nil, planChangesTo: String?, status: String, updatedAt: Date) {
