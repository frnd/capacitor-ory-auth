...
public struct LoginFlow: Codable, JSONEncodable, Hashable {
    ...
    public init(active: IdentityCredentialsType? = nil, createdAt: Date? = nil, expiresAt: Date, id: String, issuedAt: Date, oauth2LoginChallenge: String? = nil, oauth2LoginRequest: OAuth2LoginRequest? = nil, organizationId: String? = nil, refresh: Bool? = nil, requestUrl: String, requestedAal: AuthenticatorAssuranceLevel? = nil, returnTo: String? = nil, sessionTokenExchangeCode: String? = nil, state: AnyCodable?, type: String, ui: UiContainer, updatedAt: Date? = nil) {
        self.active = active
