...
public struct ProjectMetadata: Codable, JSONEncodable, Hashable {
    ...
    public init(createdAt: Date, hosts: [String], id: String, name: String, slug: String? = nil, state: State, subscriptionId: String? = nil, subscriptionPlan: String? = nil, updatedAt: Date) {
