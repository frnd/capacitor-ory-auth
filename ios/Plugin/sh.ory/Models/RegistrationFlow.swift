...
public struct RegistrationFlow: Codable, JSONEncodable, Hashable {
    ...
    public init(active: IdentityCredentialsType? = nil, expiresAt: Date, id: String, issuedAt: Date, oauth2LoginChallenge: String? = nil, oauth2LoginRequest: OAuth2LoginRequest? = nil, organizationId: String? = nil, requestUrl: String, returnTo: String? = nil, sessionTokenExchangeCode: String? = nil, state: AnyCodable?, transientPayload: AnyCodable? = nil, type: String, ui: UiContainer) {
        self.active = active
