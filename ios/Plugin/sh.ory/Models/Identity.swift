...
public struct Identity: Codable, JSONEncodable, Hashable {
    ...
    public init(createdAt: Date? = nil, credentials: [String: IdentityCredentials]? = nil, id: String, metadataAdmin: AnyCodable? = nil, metadataPublic: AnyCodable? = nil, organizationId: String? = nil, recoveryAddresses: [RecoveryIdentityAddress]? = nil, schemaId: String, schemaUrl: String, state: IdentityState? = nil, stateChangedAt: Date? = nil, traits: AnyCodable?, updatedAt: Date? = nil, verifiableAddresses: [VerifiableIdentityAddress]? = nil) {
