...
public struct NormalizedProjectRevisionThirdPartyProvider: Codable, JSONEncodable, Hashable {
    ...
    public init(applePrivateKey: String? = nil, applePrivateKeyId: String? = nil, appleTeamId: String? = nil, authUrl: String? = nil, azureTenant: String? = nil, clientId: String? = nil, clientSecret: String? = nil, createdAt: Date? = nil, id: String? = nil, issuerUrl: String? = nil, label: String? = nil, mapperUrl: String? = nil, organizationId: String? = nil, projectRevisionId: String? = nil, provider: String? = nil, providerId: String? = nil, requestedClaims: AnyCodable? = nil, scope: [String]? = nil, state: State? = nil, subjectSource: String? = nil, tokenUrl: String? = nil, updatedAt: Date? = nil) {
